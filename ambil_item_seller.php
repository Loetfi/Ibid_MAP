...
//hapus jika sudah ada
		...
		$qdel="delete from map_items_history where score_ex='SEARCH' and id_biodata='$id_biodata'";
		$rdel=mysql_query($qdel);
		//ambil next jadwal
		$url="http://www.ibid.co.id/api/map/get_jadwal_map.php";
...
header("location:map_seller.php?merk=$merk1&tahun1=$tahun11&tahun2=$tahun21&seri=$seri1&km1=$km11&km2=$km21&cc=$cc1&trans=$trans1&gr=$gr1&sgr=$sgr&warna=$warna1&model=$model1&sc=$sc1&sch=$sch1&bln=$bln1&week=$week1&loc=$loc1");
?>
