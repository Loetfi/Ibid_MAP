...
//auction item
$qlot="select * from map_items_auction where idauction_item='$id_item'";
...
<body class="nav-md">
  ...
  <div class="x_panel" style="">
			...
			<p class="text-muted well well-sm no-shadow" style="margin-top: 5px;">
				...
				<div class="col-md-3">
					  <button class="btn btn-dark btn-sm" onclick="location.href = 'dasboard_seller.php?id=<?php echo $id_page;?>';">Back To Dasboard</button>
				     <div class="x_panel">
						<div class="x_title">
						  <h2>SCORE TOTAL</h2>
          ...
          <div class="row">
		  <div class="col-md-6">
			<button class="btn btn-success btn-block" type="button" onclick="location.href = 'map_seller.php';">Check Market Database</button>
			</div>
		  <div class="col-md-6">
