...
<body class="top-navigation">
    ...
    <script>        
		...
		$('#example').DataTable( {
				...
				"serverSide": true,
				"columnDefs": [
                {className: "dt-body-center", "targets": [0,1,2,3,4,6,9,10]}
					],
				"lengthMenu": [10, 15],
				"pageLength": 10,
				"ajax":{
					url :"http://www.ibid.co.id/map/side/sidecoming_auction.php", // json datasource
