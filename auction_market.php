...
<body class="nav-md">
	...
	<?php include('include/header.php');?>
	 <!-- top navigation -->
      ...
      <div class="right_col" role="main">
		<a href="index.php"><label> Home </label></a> > Auction Market Price 
        <!-- /top tiles -->
        <br />
  ...
  <div class="x_panel" style="">
                ...
                <div class="x_content">
                <table id="datatable-responsive" id="tabledata" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                          <thead>
                            <tr>
