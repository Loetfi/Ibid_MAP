					...
					<div class="form-group">
                      ...
                      <div class="col-md-2 col-sm-3 col-xs-12">
                        <select class="form-control">
                          <?php 
						    // Kota
							$sql_kota ="SELECT schedule_kota as kota FROM webid_schedule where sts_deleted='0'";
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td align="center" vertical-align="middle">2012/08/06</td>
                              <td align="center" valign="middle">System Architect</td>
                              <td align="center" valign="middle">Edinburgh</td>
                              <td align="center" valign="middle"><a href="auction_schedule_list.php?id="><strong>61</strong></a></td>
                              <td align="center" valign="middle">2011/04/25</td>
                             </tr>
                            <tr>
                              <td><img src="upload/ibid.jpg" width="100%" height="50%"></td>
                              <td align="center" valign="middle">2012/08/06</td>
                              <td align="center" valign="middle">Accountant</td>
                              <td align="center" valign="middle">Tokyo</td>
                              <td align="center" valign="middle"><a href="auction_schedule_list.php?id="><strong>51</strong></a></td>
                              <td align="center" valign="middle">2011/07/25</td>
