...
<body class="nav-md">
  ...
  <div class="x_panel" style="">
                ...
                <label class="col-md-3">LOCATION : <strong>JAKARTA </strong> </label>
				<label class="col-md-3">LOT NO: <strong>123456</strong></label>
				<label class="col-md-3">NO POLISI : <strong>B 1234 J</strong></label>
				<br>
                </p>
					...
					<div class="col-md-5">
					<div class="x_panel">
					<img class="mySlides" src="upload/1.jpg" style="width:100%">
					<img class="mySlides" src="upload/2.jpg" style="width:100%">
					<img class="mySlides" src="upload/3.jpg" style="width:100%">
					<img class="mySlides" src="upload/4.jpg" style="width:100%">
				...
				<div class="col-md-3">
                        ...
                        <button class="btn btn-primary btn-sm" type="button">SAVE TO WATCHLIST</button>
                        <button class="btn btn-danger btn-sm pull-right" type="button" onclick="location.href = 'auction_schedule_list.php?id=<?php echo $id_page;?>';">CANCEL</button>
