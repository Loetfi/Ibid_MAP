...
<body class="top-navigation">
			...
			<?php include('header.php');?>
                ...
                <div class="row">
				 <div class="x_panel" style="">
				 	<div class="ibox-title">
								...
								<li class="active">
									<strong>Vehicle Initial Inspection List</strong>
								</li>
							</ol>
						</div>
                <div class="x_content">
				<input type="hidden" id="id_biodata" value="<?php echo $id; ?>">
                 ...
                 <table id="example" class="table table-striped">
                          <thead>
                            <tr>
							  <th width="13%"><center>Photo</center></th>
                              <th width="5%"><center>Location</center></th>
                              <th width="5%"><center>Nopol</center></th>
							  <th width="2%"><center>Year</center></th>
                              <th width="15%"><center>Make,Model<BR>Cylinder,Grade</center></th>
                              <th width="7%"><center>Register Day<br>KM</center></th>
                              <th width="10%"><center>Colour<br>MT/AT</center></th>
							  <th width="5%"><center>No BPKB<br>STNK</center></th>
							</tr>
                          </thead>
                          <tbody>
                        </table>
    ...
    <script>
		...
		$('#example').DataTable( {
				...
				"pageLength": 10,
				"ajax":{
					url :"http://10.10.11.184/map/side/sideinitial_auction.php", // json datasource
