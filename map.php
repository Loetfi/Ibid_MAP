...
$id=$_GET['id'];
$qlot="select * from webid_schedule where schedule_id='$id'";
...
<body class="nav-md">
	...
	<?php include('include/header.php');?>
	 <!-- top navigation -->
      ...
      <div class="right_col" role="main">
		<a href="index.php"><label> Home </label></a> > <a href="map.php">Market Price</a>> Database 
        <!-- /top tiles -->
        <br />
  ...
  <div class="x_panel" style="">
				...
				<label class="col-md-12"><strong><?php echo $row['schedule_location'];?> </strong> </label>
				
				</div>
				<div class="col-md-2">
				<a href="dasboard.php"><p class="text-muted well well-sm no-shadow btn btn-default" style="margin-top: 5px;">
				Back To Dasboard
				</p></a>
				</div>
				<div class="clearfix"></div>
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                          ...
                          <tbody>
							...
							<tr>
                              ...
                              <td align="center" vertical-align="middle"><?php echo $result['auc_seq'];?><br><?php echo $result['auc_nopol'];?></td>
							  ...
							  <div class="btn-group">
							  <button class="btn btn-sm btn-default btn-xs" onclick="location.href = 'auction_item_detail.php?id=<?php echo $id;?>&item=<?php echo $result['idauction_item'];?>';">Check  <br> MPD  </button>
							  <button class="btn btn-sm btn-default btn-xs" onclick="location.href = 'auction_watch_detail.php?id=<?php echo $id;?>&item=<?php echo $result['idauction_item'];?>';">Add Watch<br>List (10)</button></td>
							  </div>	
							 </tr>
                            <?php }?>
