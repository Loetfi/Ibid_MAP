	...
	<?php include('include/header.php');?>
	 <!-- top navigation -->
      ...
      <div class="right_col" role="main">
		<a href="index.php"><label> Home </label></a> > <a href="dasboard.php">Dasboard </a>> Pusrchase History 
        <!-- /top tiles -->
        <br />
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                          <thead>
                            <tr>
                              ...
                              <th width="30%"><center>Title</center></th>
                          ...
                          <tbody>
                            <?php 
							//Item auction
							$qitem="select * from map_items_history where id_biodata='$id' order by id";
							$ritem=mysql_query($qitem);
							while ($result=mysql_fetch_array($ritem)){
							$id_item=$result['idauction_item'];	
							?>
							<tr>
                              <td align="center" valign="middle"><?php echo $result['auc_date'];?></td>
                              <td align="center" valign="middle"><?php echo $result['auc_location'];?></td>
							  ...
							  <div class="btn-group">
							  <button class="btn btn-sm btn-default btn-xs" onclick="location.href = 'auction_item_detail_history.php?id=<?php echo $id;?>&item=<?php echo $result['idauction_item'];?>';">Check  <br> MPD  </button>
							  </td>
							  </div>	
							 </tr>
                            <?php }?>
