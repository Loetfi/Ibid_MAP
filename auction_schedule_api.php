	...
	$("document").ready(function(){
		...
		$.getJSON('http://localhost/ibid_corporate/api/getSchedule.php', { get_param: 'value' }, function(data) {
			$.each(data, function(index, element) {		
				...
				// alert(element.id);
				$('#datatable-responsive').find('tbody')
					.append($('<tr>')
							.append(
								'<td>'+element.tanggal+'</td>'+
								'<td>'+element.lokasi+'</td>'+
								'<td>'+element.openhouse+'</td>'+
								'<td><a href="auction_schedule_list.php?id='+element.id+'"><center><label class="btn btn-default btn-info"> '+element.jumlah+' Lot </label></center></a></td>'+
...
<body class="nav-md">
  ...
  <div class="x_panel" style="">
                <div class="x_title">
                 ...
                 <form action="auction_schedule.php" method="GET">
                  <div class="clearfix"></div>
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                          <thead>
                            <tr>
                              ...
                              <th width="30%"><center>Location</center></th>
